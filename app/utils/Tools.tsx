...
const StackIcons = () => {
    return (
        <>
            ...
            <div className="flex justify-center md:grid-cols-3 mt-0 w-full">
                <div className="grid lg:grid-cols-7 md:grid-cols-3 sm:grid-cols-4 mt-7 lg:w-4/5 md:w-4/5 border rounded-lg m-4 p-5 hover:bg-base-300">
