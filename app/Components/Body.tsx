    ...
    return(
        <>
            <div>
                ...
                <div className="flex right-0 outline w-2/3 rounded-lg m-4 p-3">
                    <p>
            ...
            <div className="outline rounded-lg p-3 m-2">
                <div className="">
                    <div className="flex grid-cols-4 justify-center items-center gap-4">
                        <StackIcons />
                    </div>
                </div>
            </div>
